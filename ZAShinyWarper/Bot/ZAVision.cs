...
namespace ZAShinyWarper
{
    internal static class ZAVision
    {
        ...
        //[[main+4202C40]+D8]
        public static IReadOnlyList<long> IngameTimePointer { get; } = [0x4202C40, 0xD8]; // +30
        // [[main+4202C40]+1B0]
        public static IReadOnlyList<long> WeatherPointer { get; } = [0x4202C40, 0x1B0]; // +00
        ...
        public static IReadOnlyList<long> GetStashedShinyPointer(int index) // +00
        {
            ...
            return [0x4203D20, 0x350, (0x8 + 0x28 * index), 0x50, 0x30, 0x00];
        }
    }
}
